                ...
                <div class="w-full">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Email/Membership ID</span>
                            <input id="login" type="text" name="login" :value="old('login')" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('login') is-invalid @enderror" placeholder="Jane Doe" required autofocus />
                            @error('login')
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input id="password" name="password" required autocomplete="current-password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('password') is-invalid @enderror" placeholder="***************" type="password" />
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong class="text-red-600">{{ $message }}</strong>
                            </span>
